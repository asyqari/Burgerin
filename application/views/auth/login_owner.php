...
<body class="bg-primary">
    <title> Login Owner - Burgerin</title>
                            ...
                            <div class="row">
                                <div class="col-lg">
                                    <div class="p-5">
                                        ...
                                        <form class="user" method="POST" action="<?= base_url('C_auth/login_owner_action'); ?>">
                                            <div class="form-group">
                                                <input type="text" class="form-control form-control-user" id="email_owner" name="email_owner" placeholder="Email....." value="<?= set_value('email_owner'); ?>">
                                                <?= form_error('email_user', '<small class="text-danger pl-3">', '</small>'); ?>
                                            </div>
                                            <div class="form-group">
                                                <input type="password" class="form-control form-control-user" id="password_owner" name="password_owner" placeholder="Password.....">
                                                <?= form_error('password_owner', '<small class="text-danger pl-3">', '</small>'); ?>
                                            </div>
                                            <button type="submit" class="btn btn-user btn-block" style="background-color : #FFBE33">
                                                Login
                                            </button>
                                        </form>
                                        <hr>
